...
export default function Navbar() {
  return (
    <nav className="navbar navbar-expand-lg navSec  ">
      <div
        id="nav-menu"
        className={`container-fluid fixed-top pe-xl-5 pe-lg-2 ps-lg-2 pe-md-2 ps-xl-5 ps-md-2 pt-1 pb-1   ${style.nav_menu}`}
      >
        <a className="navbar-brand d-flex ms-lg-5 ms-md-0  align-items-center  " href="#">
          <span className={style.span}>A</span>rjun{" "}
          <span>
            <img
              className="ms-lg-2 ms-md-2"
        ...
        >
          <div className="navbar-nav align-items-center ">
            <a
              className="nav-link home active me-lg-2 me-xl-5 me-md-5 text-info-emphasis "
              aria-current="page"
              href="#home"
            >
              HOME
            ...
            <a
              className="nav-link about active me-lg-2 me-xl-5 me-md-5 text-info-emphasis "
              aria-current="page"
              href="#about"
            >
              ABOUT
            ...
            <a
              className="nav-link skills active me-lg-2 me-xl-5 me-md-5 text-info-emphasis "
              aria-current="page"
              href="#skills"
            >
              SKILLS
            ...
            <a
              className="nav-link projects active me-lg-2 me-xl-5 me-md-5 text-info-emphasis"
              aria-current="page"
              href="#projects"
            >
              PROJECTS
            ...
            <a
              className="nav-link active me-lg-2 me-xl-5 me-md-5 text-info-emphasis"
              aria-current="page"
              href="#github"
            >
              GITHUB
            ...
            <a
              className="nav-link contact active me-lg-2 me-xl-5 me-md-5 text-info-emphasis"
              aria-current="page"
              href="#contact"
            >
              CONTACT
