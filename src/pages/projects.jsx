...
const data = [
  {
    ...
    resp: "Independently Managed all aspects of the backend. In frontend, I contributed to the creation of the  tour detail page, navbar, profile page having user booking history, and login signup page",
